package com.doublekit.wiki.document.controller;
...
public class DocumentRecentControllerTest {

    private static Logger logger = LoggerFactory.getLogger(DocumentRecentControllerTest.class);
