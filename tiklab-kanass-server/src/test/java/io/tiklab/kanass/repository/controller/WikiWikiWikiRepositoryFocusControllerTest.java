...
public class WikiWikiWikiRepositoryFocusControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WikiWikiWikiRepositoryFocusControllerTest.class);
    ...
    public void test01ForSaveRepositoryFocus() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(wikiRepositoryFocus));
