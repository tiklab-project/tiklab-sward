...
public class WikiWikiRepositoryControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WikiWikiRepositoryControllerTest.class);
    ...
    public void test01ForSaveRepository() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(wikiRepository);
