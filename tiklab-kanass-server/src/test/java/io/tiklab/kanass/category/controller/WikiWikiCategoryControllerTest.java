package io.tiklab.kanass.category.controller;
...
public class WikiWikiCategoryControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WikiWikiCategoryControllerTest.class);
    ...
    public void test01ForSaveCategory() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(wikiCategory);
