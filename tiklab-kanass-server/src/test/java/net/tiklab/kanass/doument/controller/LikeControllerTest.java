package net.tiklab.kanass.doument.controller;
...
public class LikeControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(LikeControllerTest.class);
    ...
    public void test01ForSaveLike() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(like);
