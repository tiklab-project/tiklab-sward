...
import net.tiklab.kanass.config.TestConfig;
...
public class RepositoryFocusControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RepositoryFocusControllerTest.class);
    ...
    public void test01ForSaveRepositoryFocus() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(repositoryFocus));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryFocus/createRepositoryFocus")
    ...
    public void test02ForUpdateRepositoryFocus(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryFocus/updateRepositoryFocus")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRepositoryFocus() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryFocus/findRepositoryFocus")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRepositoryFocus() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryFocus/findAllRepositoryFocus")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRepositoryFocus(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryFocus/deleteRepositoryFocus")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
